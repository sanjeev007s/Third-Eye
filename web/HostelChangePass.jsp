...
<html>
    ...
    <body>
        ...
        <center>
            ...
            <form method="post" action="HostelChangePass">
            <fieldset width="100px" height="400px">
                ...
                <table>
                    ...
                    <tr height="30px"></tr><tr height="30px"><td><input type="submit"value="Change"style="display: inline-block; background-color: #4CAF50; color: white; padding: 10px 20px; margin-bottom: 15px; border: none; border-radius: 5px; text-decoration: none; font-weight: bold;"> </td><td width="20px"></td><td><input type="reset" value="Clear" style="display: inline-block; background-color: #4CAF50; color: white; padding: 10px 20px; margin-bottom: 15px; border: none; border-radius: 5px; text-decoration: none; font-weight: bold;"><td></tr>
