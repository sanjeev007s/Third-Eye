...
<html>
    ...
    <body>
        ...
        <center>
            ...
            <h3><p align="left"> <a href="policeHome.jsp"style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;">Back</a></p></h3>
            <div style="width: 600px;height: 300px;background-color: white;">
            <form method="post" action="police_change_pass">
            <fieldset width="100px" height="400px">
                ...
                <table>
                    ...
                    <tr height="30px"></tr><tr height="30px"><td><input type="submit"value="Change"style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;"> </td><td width="20px"></td><td><input type="reset" value="Clear" style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;"></td></tr>
