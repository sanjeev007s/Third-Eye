    ...
    <body>
        ...
        <center>
            ...
            <h3><p align="left"> <a href="HotelHome.jsp" style="display: inline-block; background-color: #4CAF50; color: white; padding: 10px 20px; margin-bottom: 15px; border: none; border-radius: 5px; text-decoration: none; font-weight: bold;">Back</a></p></h3> <%
                 ...
                 %>  
            <h2 style="color:darkmagenta;">New Customer Details</h2>
            <form method="post" action="CustomerChickIn" enctype="multipart/form-data" name="frm" onsubmit="return abc();">
                <fieldset style="width:880px;height:730px;">
                    <legend><p style="color:darkcyan;">Customer Details</p></legend>
		...
		<tr>
		  <td width="20px">&nbsp;</td>
		  <td width="25px">&nbsp;</td>
		  <td width="250px">Customer first name :<span class="required"> *</span></td>
		  <td width="20px">&nbsp;</td>
		  <td width="25px">&nbsp;</td>
	  ...
	  <tr>
		  <td width="20px">&nbsp;</td>
		  <td width="25px">&nbsp;</td>
		  <td width="425px">Number of person :<span class="required"> *</span></td>
		  <td width="20px">&nbsp;</td>
		  <td width="25px">&nbsp;</td>
		...
		<tr>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td><input name="t12" style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-bottom: 0px; border-top-color: rgb(221, 221, 221); border-right-color: rgb(221, 221, 221); border-bottom-color: rgb(221, 221, 221); border-left-color: rgb(221, 221, 221); border-top-style: solid; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; height: 30px; width: 250px; font-family: Arial, Helvetica, sans-serif; font-size: 15pt; color: rgb(128, 128, 128); background-color: rgb(240, 240, 240);" type="email" /></td>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td><input name="t13" maxlength="11" style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-bottom: 0px; border-top-color: rgb(221, 221, 221); border-right-color: rgb(221, 221, 221); border-bottom-color: rgb(221, 221, 221); border-left-color: rgb(221, 221, 221); border-top-style: solid; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; height: 30px; width: 250px; font-family: Arial, Helvetica, sans-serif; font-size: 15pt; color: rgb(128, 128, 128); background-color: rgb(240, 240, 240);" type="file" /></td>
		  <td>&nbsp;</td>
	  </tr>       
	  	  		<tr>
		  <td>&nbsp;</td>
