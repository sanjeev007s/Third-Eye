  ...
  <div class="container">
    ...
    <nav>
      <ul>
        ...
        <li><a href="CitizenSingout">Sign Out</a></li>
        ...
        <aside>
          ...
          <ol type="A">
            <li>
                 ...
                 <p><a href="gustInformation.jsp" class="btn-link-blue">Upload paying guest data</a></p>
              </li>
            <li>
              
                <p><a href="citizensendinfo.jsp"class="btn-link-blue">Send Information</a></p>
               </li>
            <li>
              
                <p> <a href="CitizenViewInfo.jsp" class="btn-link-blue">View Information</a></p>
              </li>
              <p> <a href="CitizenChangePass.jsp"class="btn-link-blue">Change Password</a></p>
              </li>
