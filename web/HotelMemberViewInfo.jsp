<%-- 
    Document   : HotelMemberViewInfo
    Created on : Apr 4, 2015, 11:11:38 AM
    Author     : AJAY YADAV
--%>
...
<html>
    ...
    <body>
        ...
        <p align="left"><a href="HotelHome.jsp"style="display: inline-block; background-color: #4CAF50; color: white; padding: 10px 20px; margin-bottom: 15px; border: none; border-radius: 5px; text-decoration: none; font-weight: bold;">Back</a></p>
