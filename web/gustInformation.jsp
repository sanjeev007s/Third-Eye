...
{	position: absolute;
    ...
    <body>
        ...
        %>
        <center>
            <div style="width:900px;height: 100px;background-image: url('images/prev.jpg');">
            </div>
            <h3><p align="left"> <a href="CitizenHome.jsp"style="display: inline-block; margin-bottom: 10px; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;">Back</a></p></h3> <%
		...
		<tr>
		  ...
		  <td><input name="submit" type="submit" style="text-transform:uppercase; color:buttontext; padding:6px 0px; width:90px; border:solid 1px #9f9f9f; background-color:#B8C7C2; cursor:pointer; margin-top:0px; font-size:11px; font-family:Arial;display: inline-block; margin-bottom: 10px; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;" value="SUBMIT" /></td>
		  <td></td>
                  <td><input  type="reset" style="text-transform:uppercase; color:buttontext; padding:6px 0px; width:90px; border:solid 1px #9f9f9f; background-color:#B8C7C2; cursor:pointer; margin-top:0px; font-size:11px; font-family:Arial;display: inline-block; margin-bottom: 10px; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;" value="CLEAR" /></td>
