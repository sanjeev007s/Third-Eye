...
<html>
    ...
    <body>
        ...
        <form method="get" action="FindData4.jsp">
            <table>  
                <tr><td><h3 style="color: blueviolet;">Enter Id_no</h3></td><td></td><td><input type="text" name="t1"></td><td></td><td><input type="submit" style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;"value="Submit"></td></tr>
