 ...
 */
public class AdminSendInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           db.pstmt=db.con.prepareStatement("insert into admininformation(sub,msg,infodata) values(?,?,?)");
         ...
         if(x>0)
         {
           response.sendRedirect("AdminSendInformattion.jsp?msg=Information send sucessfull!!!");
         }
         else
         {
